...
adata.obs = adata.obs.drop(columns=['decontX_contamination', 'n_genes_by_counts', 'log1p_n_genes_by_counts', 'log1p_total_counts', 'total_counts_mt', 'log1p_total_counts_mt', 'pct_counts_mt', 'scDblFinder_score', 'total_counts_ERCC', 'log1p_total_counts_ERCC', 'pct_counts_ERCC'])
